...
export function ObjectiveCreation({
  ...
  useEffect(() => {
    if (kogniiPrefillData && isOpen) {
      ...
      if (
        kogniiPrefillData.title &&
        kogniiPrefillData.description &&
        kogniiPrefillData.category
      ) {
  ...
  const removeFromArray = (
    field: keyof typeof objectiveData,
    index: number,
  ) => {
    setObjectiveData((prev) => ({
      ...prev,
  ...
  const acceptAISuggestion = () => {
    if (aiSuggestedTeam) {
      updateObjectiveData(
        "assignedTeam",
        aiSuggestedTeam.map((member) => member.id),
      );
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Textarea
                ...
                onChange={(e) =>
                  updateObjectiveData("description", e.target.value)
                }
                rows={4}
              />
            </div>
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  updateObjectiveData("category", value)
                }
              >
                <SelectTrigger>
          ...
          <div className="space-y-4">
            <div>
              ...
              <Select
                ...
                onValueChange={(value) =>
                  updateObjectiveData("priority", value)
                }
              >
                <SelectTrigger>
              ...
              <Card className="border-blue-200">
                ...
                <CardContent>
                      ...
                      >
                        <div>
                          ...
                          <div className="text-xs text-blue-600">
                            Skills: {member.skills.slice(0, 3).join(", ")}
                          </div>
                        </div>
                        <div className="text-right">
                          <div
                            className={`text-sm font-medium ${getWorkloadColor(member.currentWorkload)}`}
                          >
                  ...
                  <div className="flex gap-2 mt-4">
                    ...
                    <Button
                      variant="outline"
                      onClick={() => setShowTeamSuggestion(false)}
                    >
                      Manual Selection
                    </Button>
                  </div>
                  ...
                  {teamMembers.map((member) => (
                    ...
                    >
                      <div className="flex items-center space-x-3">
                        <Checkbox
                          checked={objectiveData.assignedTeam.includes(
                            member.id,
                          )}
                          onCheckedChange={(checked) => {
                            if (checked) {
                              updateObjectiveData("assignedTeam", [
                                ...objectiveData.assignedTeam,
                                member.id,
                              ]);
                            } else {
                              updateObjectiveData(
                                "assignedTeam",
                                objectiveData.assignedTeam.filter(
                                  (id) => id !== member.id,
                                ),
                              );
                            }
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <Badge
                      variant={
                        objectiveData.priority === "Critical"
                          ? "destructive"
                          : "secondary"
                      }
                    >
                  ...
                  <div>
                    ...
                    <p className="font-medium">
                      {objectiveData.deadline
                        ? format(objectiveData.deadline, "PPP")
                        : "Not set"}
                    </p>
                  </div>
                </div>
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      ...
      >
        <DialogHeader>
          ...
          <DialogDescription>
            Create a new strategic objective with team assignments, metrics, and
            deadlines.
          </DialogDescription>
        </DialogHeader>
