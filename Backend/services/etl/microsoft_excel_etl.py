"""
 ULTIMATE Microsoft Excel ETL - FULL FEATURE SET
...
async def run_microsoft_excel_etl(
    ...
    """
     ULTIMATE Microsoft Excel ETL with ALL features.
    ...
    try:
        ...
        async with httpx.AsyncClient(headers=headers, timeout=60.0) as client:
            ...
            if all_cleaned_files:
                ...
                file_path = f"{user_id}/microsoft_excel/all_files.json"
                ...
                combined_file_path = f"{user_id}/microsoft_excel/all_files_latest.json"
                await queue_embedding(user_id, combined_file_path)
            ...
            logging.info(f"   Files processed: {successful_count}/{len(excel_files)}")
