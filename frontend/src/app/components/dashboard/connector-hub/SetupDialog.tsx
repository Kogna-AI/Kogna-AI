                ...
                <CardContent className="pt-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="font-semibold text-amber-800">
                      Premium Native Integration
                    </span>
                  </div>
                  <p className="text-sm text-amber-700">
                    Get the deepest insights and most advanced features with our
                    native WBS system. Includes AI-powered optimization,
                    predictive analytics, and real-time team balancing.
                  </p>
                </CardContent>
              </Card>
            )}
              ...
              <CardContent className="pt-4">
                <div className="space-y-4">
                  ...
                  <RadioGroup
                    ...
                    onValueChange={setSelectedSyncMode}
                  >
                    {syncModes.map((mode) => (
                      <div key={mode.id} className="space-y-2">
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem
                            ...
                            id={mode.id}
                            disabled={
                              mode.isPremium && connector.id !== "kognacore"
                            }
                          />
                          <Label
                            htmlFor={mode.id}
                            ...
                            <div className="flex items-start gap-3">
                              ...
                              <div>
                                ...
                                <ul className="text-sm text-amber-700 space-y-1">
                                  ...
                                  <li>
                                    • Team assignments and progress updates flow
                                    both ways
                                  </li>
                                  <li>
                                    • WBS changes trigger updates in connected
                                    systems
                                  </li>
                                  <li>
                                    • AI-optimized resource allocation syncs
                                    across tools
                                  </li>
                                </ul>
                              </div>
