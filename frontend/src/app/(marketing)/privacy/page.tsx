    ...
    <div className="min-h-screen bg-slate-50 py-12 md:py-24">
      <div className="container mx-auto px-4 md:px-6 max-w-4xl">
        <div className="bg-white rounded-2xl shadow-sm border p-8 md:p-12 text-slate-800">
          <h1 className="text-3xl md:text-4xl font-bold mb-4 text-slate-900">Privacy Policy</h1>
          ...
          <div className="space-y-8 text-slate-600 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4 text-slate-900">Interpretation and Definitions</h2>
              
              <h3 className="text-xl font-bold mb-3 text-slate-800">Interpretation</h3>
              <p className="mb-4">
                The words whose initial letters are capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
              </p>
              
              <h3 className="text-xl font-bold mb-3 text-slate-800">Definitions</h3>
              <p className="mb-4">For the purposes of this Privacy Policy:</p>
              <ul className="list-disc pl-5 space-y-2">
                <li><strong>Account</strong> means a unique account created for You to access our Service or parts of our Service.</li>
                <li><strong>Affiliate</strong> means an entity that controls, is controlled by, or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</li>
                <li><strong>Application</strong> refers to Kogna AI, the software program provided by the Company.</li>
                <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to Kogna Inc, 55 SW 5th Terrace Unit 2151 Gainesville  FL 32601 United States.</li>
                ...
                <li><strong>Website</strong> refers to Kogna AI, accessible from <a href="https://kogna.io" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Kogna.io</a>.</li>
                <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
              </ul>
            </section>

            <section>
              <h2 className="text-2xl font-bold mb-4 text-slate-900">Collecting and Using Your Personal Data</h2>
              
              <h3 className="text-xl font-bold mb-3 text-slate-800">Types of Data Collected</h3>
              ...
              <h4 className="font-bold mt-4 mb-2">Tracking Technologies and Cookies</h4>
              <p className="mb-4">
            ...
            <section>
              <h3 className="text-xl font-bold mb-3 text-slate-800">Use of Your Personal Data</h3>
              ...
              <p className="mt-6 mb-4">We may share Your Personal Data in the following situations:</p>
              <ul className="list-disc pl-5 space-y-2">
            ...
            <section>
              <h3 className="text-xl font-bold mb-3 text-slate-800">Retention of Your Personal Data</h3>
              <p className="mb-4">
              ...
              <p className="mb-4">We may retain Personal Data beyond the periods stated above for different reasons:</p>
              <ul className="list-disc pl-5 mb-4 space-y-1">
              ...
              <p className="mb-4">You may request information about how long We will retain Your Personal Data by contacting Us.</p>
              <p className="mb-4">When retention periods expire, We securely delete or anonymize Personal Data according to the following procedures:</p>
              <ul className="list-disc pl-5 mb-4 space-y-1">
            ...
            <section>
              <h3 className="text-xl font-bold mb-3 text-slate-800">Transfer of Your Personal Data</h3>
              <p className="mb-4">
            ...
            <section>
              <h3 className="text-xl font-bold mb-3 text-slate-800">Delete Your Personal Data</h3>
              <p className="mb-4">
            ...
            <section>
              <h3 className="text-xl font-bold mb-3 text-slate-800">Disclosure of Your Personal Data</h3>
              
              <h4 className="font-bold mt-4 mb-2">Business Transactions</h4>
              <p className="mb-4">
                If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.
              </p>
              
              <h4 className="font-bold mt-4 mb-2">Law enforcement</h4>
              <p className="mb-4">
                Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).
              </p>

              <h4 className="font-bold mt-4 mb-2">Other legal requirements</h4>
            ...
            <section>
              <h3 className="text-xl font-bold mb-3 text-slate-800">Security of Your Personal Data</h3>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4 text-slate-900">Children's Privacy</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4 text-slate-900">Links to Other Websites</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold mb-4 text-slate-900">Changes to this Privacy Policy</h2>
              <p className="mb-4">
            ...
            <section>
              ...
              <ul className="list-disc pl-5">
                <li>By email: <a href="mailto:Getkogna@outlook.com" className="text-blue-600 hover:underline">Getkogna@outlook.com</a></li>
              </ul>
            </section>
          </div>
        </div>
