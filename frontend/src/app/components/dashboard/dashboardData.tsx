...
export const aiInsights = [
  {
    ...
    description:
      "AI suggests reallocating 15% of budget from traditional to digital channels",
    impact: "High",
    confidence: "94%",
    ...
    detailedAnalysis: {
      currentState:
        "Current marketing spend shows 3.2x ROI on digital vs 1.8x on traditional channels",
      recommendation:
        "Shift $450K from print advertising, radio, and TV to social media advertising, content marketing, and SEO",
      expectedOutcome:
        "38% increase in qualified leads, 23% reduction in customer acquisition cost",
      riskFactors: [
        "Market saturation in digital space",
  ...
  },
  {
    ...
    detailedAnalysis: {
      currentState:
        "Development team working at 95% capacity with 3 critical projects in pipeline",
      recommendation:
        "Hire 2 senior developers, redistribute current workload, and implement better project prioritization",
      expectedOutcome:
        "Prevent burnout, maintain code quality, ensure on-time delivery",
      riskFactors: [
        "Burnout leading to resignations",
        "Quality degradation",
        "Missed deadlines",
      ],
      actionSteps: [
  ...
  },
  {
    ...
    description:
      "Teams with weekly sync meetings show 23% higher project completion rates",
    impact: "Medium",
    confidence: "91%",
    ...
    detailedAnalysis: {
      currentState:
        "Analysis of 47 projects shows correlation between meeting frequency and success rates",
      recommendation:
        "Implement structured weekly cross-functional sync meetings for all active projects",
      expectedOutcome:
        "23% improvement in project completion rates, 15% reduction in rework",
      riskFactors: [
        "Meeting fatigue",
...
export const upcomingActions = [
  {
    task: "Q2 Strategy Review",
    due: "Tomorrow",
    priority: "high",
    status: "pending",
  },
  {
    task: "Team Performance Analysis",
    due: "2 days",
    priority: "medium",
    status: "in-progress",
  },
  {
    task: "Budget Reallocation Meeting",
    due: "3 days",
    priority: "high",
    status: "pending",
  },
