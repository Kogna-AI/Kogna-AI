...
export const connectors: Connector[] = [
  {
    ...
    name: "KognaCore WBS",
    description:
      "Our native Work Breakdown Structure system with deepest AI insights and real-time optimization",
  ...
  },
  {
    ...
    name: "Jira",
    description:
      "Connect with Atlassian Jira for issue tracking and agile project management",
  ...
  },
  {
    ...
    description:
      "Enterprise project management integration with Microsoft Project",
